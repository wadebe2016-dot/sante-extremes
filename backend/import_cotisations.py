...
def import_cotisations(excel_file, db_path):
    ...
    months_columns = {
        "Sept": 3, "Oct": 4, "Nov": 5, "Dec": 6,
        "Jan": 7, "Fev": 8, "Mars": 9, "Avr": 10,
        "Mai": 11, "Juin": 12, "Juil": 13, "Aout": 14, "Sept(2)": 15,
    }
    ...
    for row_num in range(2, ws.max_row + 1):
        ...
        for month_name, col_num in months_columns.items():
            ...
            if montant and montant > 0:
                ...
                try:
                    cursor.execute(
                        "INSERT INTO cotisations (member_id, montant, moyen, date_paiement) VALUES (?, ?, ?, ?)",
                        (member_id, montant, "Espèce", date_paiement)
                    )
                    cotisations_added += 1
